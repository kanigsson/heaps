...
package body Bench.Skew_Heap is

   package Arena renames Heaps.Skew_Pool;
   ...
   --  keys between two arrays. This is the same adapter shape the leftist
   --  arena needs, for the same reason.
   --
   --  Heaps.Skew_Pool is instantiated with 2 ** 20 nodes, which is
